...
function ChordSearch() {
  ...
  return (
    <div className='chord-search__component'>
      ...
      <h4 id='accent'>This section will help you turn your new song into a hit</h4>
      <p>There's two possible answers you can get from this tool:
      </p> 
      <p className='chords-mode__explanation'>
      What should be my next chord to make this song a hit?
      <br/>
      or
      <br />
      ...
      <select 
        ...
        <option value="songs">Other songs</option>
      </select>
      ...
      {showResults && <div className="chordsResults">
        ...
        {(chordsMode==='songs') && chordsResults.map(result => (
          <div className='chord-details' key={result.url}>
            ...
            <p>
              You can check the song out <a href={result.url} target='_blank' rel="noreferrer">here</a>.
            </p>
          </div>
        ))}
      </div>}
